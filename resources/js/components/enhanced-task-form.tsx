...
export default function EnhancedTaskForm({ task, categories, tags, goals, allTasks = [], onCancel }: TaskFormProps) {
    ...
    const toggleDependency = (taskId: number) => {
        if (data.dependencies.includes(taskId)) {
            setData('dependencies', data.dependencies.filter(id => id !== taskId));
        } else {
        ...
        <form onSubmit={submit} className="space-y-8">
            ...
            <div className="grid gap-8 lg:grid-cols-3">
                ...
                <div className="space-y-6 lg:col-span-2">
                    <div>
                        <h3 className="mb-4 text-lg font-bold text-gray-900 dark:text-white">Task Details</h3>
                    </div>
            {/* Title */}
            <div>
                <Label htmlFor="title">
            ...
            <div>
                ...
                <div className="space-y-6">
                    <div>
                        <h3 className="mb-4 text-lg font-bold text-gray-900 dark:text-white">Additional Options</h3>
                    </div>
                        ...
                        <div className="grid gap-4 md:grid-cols-2">
                            <div>
                                ...
                                <select
                                    ...
                                    onChange={(e) => setData('recurrence_type', e.target.value as any)}
                                    className="mt-1 w-full rounded-lg border border-gray-300 px-3 py-2 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white"
                                >
