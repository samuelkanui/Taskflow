...
import { 
    BookOpen, CheckSquare, Calendar, Columns3, Target, Folder, Tag, FileText, 
    BarChart3, Plus, Search, Filter, Copy, Edit2, Trash2, Sparkles, Clock,
    ChevronRight, Lightbulb, Zap, Shield, Globe
} from 'lucide-react';
            ...
            <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
                <div className="mx-auto max-w-[95%] 2xl:max-w-[1600px] space-y-8 p-6 lg:p-8">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="mt-2 flex items-center gap-2 text-lg text-white/90">
                                        ...
                                        Learn how to use the Task Management System
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="relative overflow-hidden rounded-2xl border border-gray-200 bg-gradient-to-br from-white to-gray-50 p-8 shadow-lg dark:border-gray-700 dark:from-gray-800 dark:to-gray-900">
                        <div className="absolute right-0 top-0 h-full w-1/3 bg-gradient-to-l from-indigo-500/5 to-transparent"></div>
                        <div className="relative">
                            ...
                            <div className="space-y-4 text-gray-700 dark:text-gray-300">
                                <p className="text-lg leading-relaxed">
                                    Welcome to your Task Management System! This powerful application helps you organize, track, and complete your tasks efficiently.
                                </p>
                                <div className="grid gap-4 md:grid-cols-3">
                                    <div className="rounded-xl bg-gradient-to-br from-green-50 to-emerald-50 p-6 shadow-md dark:from-green-900/20 dark:to-emerald-900/20">
                                        ...
                                        <h3 className="mb-2 font-bold text-gray-900 dark:text-white">1. Create Tasks</h3>
                                        <p className="text-sm">Click "New Task" to create your first task with title, priority, and due date.</p>
                                    </div>
                                    <div className="rounded-xl bg-gradient-to-br from-blue-50 to-indigo-50 p-6 shadow-md dark:from-blue-900/20 dark:to-indigo-900/20">
                                        ...
                                        <h3 className="mb-2 font-bold text-gray-900 dark:text-white">2. Organize</h3>
                                        <p className="text-sm">Use categories, tags, and goals to keep your tasks organized and grouped.</p>
                                    </div>
                                    <div className="rounded-xl bg-gradient-to-br from-purple-50 to-pink-50 p-6 shadow-md dark:from-purple-900/20 dark:to-pink-900/20">
                                        ...
                                        <h3 className="mb-2 font-bold text-gray-900 dark:text-white">3. Track Progress</h3>
                                        <p className="text-sm">View analytics and progress tracking to stay on top of your goals.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="grid gap-6 lg:grid-cols-2">
                        {/* Dashboard */}
                        <FeatureCard
                            icon={<Globe className="size-6 text-blue-600 dark:text-blue-400" />}
                            title="Dashboard"
                        ...
                        {/* Tasks */}
                        <FeatureCard
                            icon={<CheckSquare className="size-6 text-green-600 dark:text-green-400" />}
                            title="Tasks"
                        ...
                        {/* Calendar */}
                        <FeatureCard
                            icon={<Calendar className="size-6 text-purple-600 dark:text-purple-400" />}
                            title="Calendar"
                        ...
                        {/* Kanban */}
                        <FeatureCard
                            icon={<Columns3 className="size-6 text-cyan-600 dark:text-cyan-400" />}
                            title="Kanban Board"
                        ...
                        {/* Goals */}
                        <FeatureCard
                            icon={<Target className="size-6 text-emerald-600 dark:text-emerald-400" />}
                            title="Goals"
                        ...
                        {/* Categories */}
                        <FeatureCard
                            icon={<Folder className="size-6 text-orange-600 dark:text-orange-400" />}
                            title="Categories"
                        ...
                        {/* Tags */}
                        <FeatureCard
                            icon={<Tag className="size-6 text-pink-600 dark:text-pink-400" />}
                            title="Tags"
                        ...
                        {/* Templates */}
                        <FeatureCard
                            icon={<FileText className="size-6 text-teal-600 dark:text-teal-400" />}
                            title="Templates"
                        ...
                        {/* Analytics */}
                        <FeatureCard
                            icon={<BarChart3 className="size-6 text-indigo-600 dark:text-indigo-400" />}
                            title="Analytics"
                    ...
                    {/* Tips & Tricks */}
                    <div className="relative overflow-hidden rounded-2xl border border-gray-200 bg-gradient-to-br from-white to-gray-50 p-8 shadow-lg dark:border-gray-700 dark:from-gray-800 dark:to-gray-900">
                        <div className="absolute right-0 top-0 h-full w-1/3 bg-gradient-to-l from-yellow-500/5 to-transparent"></div>
                        <div className="relative">
                            <div className="mb-6 flex items-center gap-3">
                    ...
                    <div className="relative overflow-hidden rounded-2xl border border-gray-200 bg-gradient-to-br from-white to-gray-50 p-8 shadow-lg dark:border-gray-700 dark:from-gray-800 dark:to-gray-900">
                        ...
                        <div className="relative">
                            <div className="mb-6 flex items-center gap-3">
                                ...
                                <h2 className="text-3xl font-bold text-gray-900 dark:text-white">Need More Help?</h2>
                            </div>
                            <div className="space-y-4 text-gray-700 dark:text-gray-300">
                                <p className="text-lg">
                                ...
                                <ul className="space-y-2 pl-6">
                                    <li className="flex items-start gap-2">
                                        ...
                                        <span>Check the sidebar navigation for quick access to all features</span>
                                    </li>
                                    <li className="flex items-start gap-2">
                                        <ChevronRight className="mt-1 size-5 text-blue-600 dark:text-blue-400" />
                                        <span>Hover over icons and buttons to see tooltips with more information</span>
                                    </li>
                                    <li className="flex items-start gap-2">
                                        <ChevronRight className="mt-1 size-5 text-blue-600 dark:text-blue-400" />
                                        <span>All data is saved automatically when you create or update items</span>
                                    </li>
                                    <li className="flex items-start gap-2">
                                        <ChevronRight className="mt-1 size-5 text-blue-600 dark:text-blue-400" />
                                        <span>Your data is private and secured to your account only</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
...
function TipCard({ title, description }: TipCardProps) {
    return (
        <div className="rounded-xl border border-yellow-200 bg-gradient-to-br from-yellow-50 to-amber-50 p-4 dark:border-yellow-800 dark:from-yellow-900/20 dark:to-amber-900/20">
            <h4 className="mb-2 font-bold text-gray-900 dark:text-white">{title}</h4>
