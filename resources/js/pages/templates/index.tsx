                        ...
                        <div className="relative overflow-hidden rounded-2xl border-2 border-dashed border-gray-300 bg-gradient-to-br from-gray-50 to-white p-16 text-center shadow-lg dark:border-gray-700 dark:from-gray-800 dark:to-gray-900">
                            ...
                            <div className="relative">
                                ...
                                <p className="mb-6 text-gray-600 dark:text-gray-400">
                                    Create your first template to quickly
                                    generate similar tasks with consistent
                                    settings!
                                </p>
                                <Button
                                    onClick={() => openModal()}
                            ...
                            {templates.map((template) => (
                                ...
                                >
                                    ...
                                    <div className="relative z-10 mb-4 flex flex-wrap gap-2">
                                        <span
                                            className={`rounded-lg px-3 py-1 text-xs font-bold tracking-wide uppercase shadow-sm ${getPriorityColor(template.priority)}`}
                                        >
                                            {template.priority}
                                        </span>
                                        {template.category && (
