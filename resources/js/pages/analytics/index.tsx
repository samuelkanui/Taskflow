...
import { BarChart3, PieChart as PieChartIcon, TrendingUp, Target, CheckCircle2, Clock, AlertCircle, Sparkles, Activity } from 'lucide-react';
...
interface AnalyticsPageProps {
    ...
    goalProgress: Array<{ name: string; progress: number; current: number; target: number }>;
...
export default function AnalyticsIndex() {
    const { tasksByStatus, tasksByPriority, tasksByCategory, tasksOverTime, completionRateOverTime, goalProgress, monthlyCompletion, stats } = usePage<AnalyticsPageProps>().props;
            ...
            <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
                <div className="mx-auto max-w-[95%] 2xl:max-w-[1600px] space-y-8 p-6 lg:p-8">
                    ...
                    <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-emerald-600 via-teal-600 to-cyan-600 p-8 shadow-2xl lg:p-12">
                        ...
                        <div className="relative z-10">
                            ...
                            <p className="mt-3 max-w-2xl text-lg text-white/90 lg:text-xl">
                                Track your productivity trends and visualize your progress over time
                            </p>
                        </div>
                        {/* Decorative elements */}
                    ...
                    <div className="grid gap-8 lg:grid-cols-2">
                        ...
                        <div className="group relative overflow-hidden rounded-2xl border border-gray-200 bg-white p-8 shadow-lg transition-all hover:shadow-2xl dark:border-gray-700 dark:bg-gray-800">
                            <div className="absolute right-0 top-0 h-full w-1/4 bg-gradient-to-l from-indigo-500/5 to-transparent"></div>
                            <div className="relative mb-6 flex items-center gap-3">
                        ...
                        <div className="group relative overflow-hidden rounded-2xl border border-gray-200 bg-white p-8 shadow-lg transition-all hover:shadow-2xl dark:border-gray-700 dark:bg-gray-800">
                            <div className="absolute right-0 top-0 h-full w-1/4 bg-gradient-to-l from-green-500/5 to-transparent"></div>
                            <div className="relative mb-6 flex items-center gap-3">
                    ...
                    <div className="grid gap-8 lg:grid-cols-2">
                        ...
                        <div className="group relative overflow-hidden rounded-2xl border border-gray-200 bg-white p-8 shadow-lg transition-all hover:shadow-2xl dark:border-gray-700 dark:bg-gray-800">
                            <div className="absolute right-0 top-0 h-full w-1/4 bg-gradient-to-l from-cyan-500/5 to-transparent"></div>
                            <div className="relative mb-6 flex items-center gap-3">
                        ...
                        <ResponsiveContainer width="100%" height={350}>
                            <LineChart data={tasksOverTime}>
                                ...
                                <Tooltip />
                                <Legend />
                                <Line type="monotone" dataKey="count" stroke="#3B82F6" strokeWidth={2} name="Tasks Created" />
                            </LineChart>
                        </ResponsiveContainer>
                    </div>
                        ...
                        <div className="group relative overflow-hidden rounded-2xl border border-gray-200 bg-white p-8 shadow-lg transition-all hover:shadow-2xl dark:border-gray-700 dark:bg-gray-800">
                            <div className="absolute right-0 top-0 h-full w-1/4 bg-gradient-to-l from-emerald-500/5 to-transparent"></div>
                            <div className="relative mb-6 flex items-center gap-3">
                        ...
                        <ResponsiveContainer width="100%" height={350}>
                            <LineChart data={completionRateOverTime}>
                                ...
                                <Tooltip />
                                <Legend />
                                <Line type="monotone" dataKey="rate" stroke="#10B981" strokeWidth={2} name="Completion %" />
                            </LineChart>
                        </ResponsiveContainer>
                    </div>
                </div>
                    ...
                    {goalProgress.length > 0 && (
                        <div className="group relative overflow-hidden rounded-2xl border border-gray-200 bg-white p-8 shadow-lg transition-all hover:shadow-2xl dark:border-gray-700 dark:bg-gray-800">
                            <div className="absolute right-0 top-0 h-full w-1/4 bg-gradient-to-l from-violet-500/5 to-transparent"></div>
                            <div className="relative mb-6 flex items-center gap-3">
                    ...
                    <div className="relative overflow-hidden rounded-2xl border border-gray-200 bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 p-12 shadow-2xl dark:border-gray-700 dark:from-blue-900/20 dark:via-purple-900/20 dark:to-pink-900/20 lg:p-16">
                        ...
                        {/* Decorative elements */}
                        <div className="absolute -left-20 -top-20 size-40 rounded-full bg-blue-500/10 blur-3xl"></div>
                        <div className="absolute -bottom-20 -right-20 size-40 rounded-full bg-purple-500/10 blur-3xl"></div>
                    </div>
                </div>
            </div>
        </AppLayout>
